...
from tf_keras.metrics import BinaryAccuracy, AUC
...
class EnsembleModel(tf.keras.Model):
  ...
  """
  def __init__(self, num_classes, feature_extractor, vits):
    ...
    self.meta1 = tf.keras.layers.Dense(16, activation="relu")
    self.meta2 = tf.keras.layers.Dense(num_classes, activation=activation)
    self.print = True
